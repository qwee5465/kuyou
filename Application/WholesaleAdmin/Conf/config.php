...
return array(
	...
	"OUT_STOCK_COLUMN_NEED" =>"gname=0,alias=1,bname=1,uname=0,num=0,num1=1,than=1,price=0,tax_price=1,price1=1,j_price=1,cd_num=1,stock=1,remarkb=1,totalb=0,rweight=1,machining=1,check_num=0,totalb1=1",
